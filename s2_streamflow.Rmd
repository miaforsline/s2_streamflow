...
wy2018_na <- wy2018_clean %>% 
  within(stream_height_ft <- 99 * (date %between% as.POSIXct(c('2018-12-01', '2018-12-03'))))



subset <- subset(wy2018_clean, datetime >= as.POSIXct("2018-12-01 00:00:00", tz = "UTC") & 
                   datetime <= as.POSIXct("2018-12-03 12:00:00", tz = "UTC"))

subset2 <- subset %>% 
  mutate(stream_height_ft = replace(stream_height_ft, datetime == 0, 99))





subset3 <- within(subset, stream_height_ft <- NA * (datetime %between% as.Date(c('2018-12-01 00:00:00', '2018-12-03 12:00:00'))))





if(wy2018_clean$datetime >= as.POSIXct("2018-12-01 00:00:00", tz = "UTC") & wy2018_clean$datetime <= as.POSIXct("2018-12-03 12:00:00", tz = "UTC")){
  print("hi")
}
