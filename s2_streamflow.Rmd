...
this time period to smooth out the overall curve of streamflow.
...
-   Plot stripchart data (as lines) and manual streamflow data (as
    points)
...
-   Clean the data
    ...
    -   Extract year to subset all precipitation data to 2017 - present
...
## Combine streamflow, precipitation, and air temp 
