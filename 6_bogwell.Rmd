...
-   First, create a function for reading in Campbell DataLogger .dat files:
...
-   Next, define constants to convert between feet and meters:
...
-   Use `ggpairs()` to create correlation matrices to compare shaft
    encoder WTE data from each site

    -   Calculate the correlation coefficients

-   Use `geom_smooth()` to plot a linear regression line for each panel
...
```{r regression_line}
#create a function to create linear regression line using geom_smooth() 
