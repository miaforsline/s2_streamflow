...
p2 <- ggplot(data = s2_join_sub) + 
  ...
  labs(x = "Manual Stripchart", 
       y = "Shaft Encoder",
       title = paste0("S2 1:1 Daily Max WTE Comparison (", min_year, "-", max_year, ")")
       ) + 
  theme(plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5, 
                                     size = 7),
...
p4 <- ggplot(data = s4_join_sub) + 
  ...
  labs(x = "Manual Stripchart", 
       y = "Shaft Encoder",
       title = paste0("S4 1:1 Daily Max WTE Comparison (", min_year, "-", max_year, ")")
       ) + 
  theme(plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5, 
                                     size = 7),
...
p5 <- ggplot(data = s5_join_sub) + 
  ...
  labs(x = "Manual Stripchart", 
       y = "Shaft Encoder",
       title = paste0("S5 1:1 Daily Max WTE Comparison (", min_year, "-", max_year, ")")
       ) + 
  theme(plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5, 
                                     size = 7),
...
p6 <- ggplot(data = s6_join_sub) + 
  ...
  labs(x = "Manual Stripchart", 
       y = "Shaft Encoder",
       title = paste0("S6 1:1 Daily Max WTE Comparison (", min_year, "-", max_year, ")")
       ) + 
  theme(plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5, 
                                     size = 7),
