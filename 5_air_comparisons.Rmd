...
Note that this file is being knit as [`index.html`](https://github.com/miaforsline/air_comparisons/blob/main/index.html) into the [`air_comparisons` repository](https://github.com/miaforsline/precip_comparisons) in order to update the [GitHub pages website](https://miaforsline.github.io/air_comparisons/), where the plots can be viewed online. 