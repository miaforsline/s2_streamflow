...
```
- Plot the differences over time, where the difference is calculated as `point_gage` - `stripchart_stage` 
...
-   Join the manual checkpoint (`point_gage`) dataset with the
    continuous stripchart dataset (`all_streamflow`)
